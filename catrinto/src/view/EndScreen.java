...
public class EndScreen extends ScreenAdapter implements ActionListener{
	...
	EndScreen(View view, boolean ganhou) {
		...
		if (ganhou == false) {
			JLabel logoPerdeu = new JLabel("Você perdeu :(", new ImageIcon("src/view/Game_Over.png"), 0);
			...
			JLabel logoGanhou = new JLabel("Você ganhou :)", new ImageIcon("src/view/Game_over.png"), 0);
